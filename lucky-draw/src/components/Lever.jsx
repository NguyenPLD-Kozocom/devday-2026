...
/**
 * Lever — A draggable vintage mechanical lever.
 *
 * Props:
 *  - onPull:   callback fired when the lever is pulled past the threshold
 *  - disabled: prevents lever interaction while machine is running
 *
 * Behaviour:
 *  - User drags the knob downward (y axis, constrained 0..120px)
 *  - If released past 80px threshold → fires onPull, then snaps back
 *  - If released early → snaps back, no action
 *  - Spring physics give a satisfying "snap" feel
 */
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            top: '30px',
            background: 'linear-gradient(90deg, #667788 0%, #aabbcc 40%, #99aabb 60%, #556677 100%)',
        ...
        <div
          ...
          style={{
            ...
            top: '40px',
            background: 'linear-gradient(90deg, #334455 0%, #556677 50%, #334455 100%)',
